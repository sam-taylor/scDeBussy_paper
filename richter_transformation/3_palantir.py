...
def run_cell_aligndtw(path, batch_key, start_cell_type, end_cell_type, cell_type_col):
    ...
    for i, patient in enumerate(patients):
        ...
        logging.info("Filtering highly variable genes...")
        sc.pp.highly_variable_genes(adata_patient, n_top_genes=n_top_genes, flavor='seurat_v3')
        ...
        sc.pp.neighbors(adata_patient, n_neighbors=n_neighbors)
...
def run_harmony(path, batch_key, start_cell_type, end_cell_type, cell_type_col):
    ...
    logging.info("Drawing graph with Harmony...")
    ...
    logging.info(f"Saving tumor cells adata to path: {path}")
...
def run_scvi(path, batch_key, start_cell_type, end_cell_type, cell_type_col):
    ...
    logging.info("Computing neighbors with scVI...")
