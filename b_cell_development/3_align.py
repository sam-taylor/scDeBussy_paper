...
path = "../data/HCA-BM/results/"
patients = ['1', '2', '3', '4', '5', '6', '7', '8']
cluster_ordering = ['Pro-B cells', 'Pre-B cells', 'Naive B cells']
...
combined_adata, df = create_cellrank_probability_df(h5ad_files, 'anno', patients, cluster_ordering, 'palantir_pseudotime')
